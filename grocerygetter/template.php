 ...
 */
function grocerygetter_preprocess_html(&$variables) {
  // Add reset.css
 ...
 * Override or insert variables into the html template.
 */
function grocerygetter_process_html(&$variables) {
 ...
 */
function grocerygetter_process_page(&$variables) {
 ...
 */
function grocerygetter_preprocess_block(&$variables) {
 ...
 */
function grocerygetter_breadcrumb($variables) {
 ...
 */
function grocerygetter_more_link($variables) {
 ...
 *     of that type.
 */
function grocerygetter_status_messages($variables) {
  $output = '';
 ...
 */
function grocerygetter_tablesort_indicator($variables) {
